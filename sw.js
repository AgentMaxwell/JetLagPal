...
// Manchester/Birmingham & West Midlands/London station data with zero network.
const SHELL_ASSETS = [
    './',
    './index.html',
    './styles.css',
    ...
    './data/london_boundaries.json',
    './data/london_farezones.json',
    './data/london_pois.json',
    './data/london_transport.json',
    './icons/icon-192.png',
    './icons/icon-512.png',
];
